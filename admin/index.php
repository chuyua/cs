    ...
    <body>
        ...
        <div class="container">
            ...
            <ul class="layui-nav right" lay-filter="">
				...
				<li class="layui-nav-item to-index"><a href="http://www.w8888.vip" target="_blank">下载源码</a></li>
            </ul>
        ...
        <!-- 底部开始 -->
        <div class="footer">
            <div class="copyright">Copyright ©2018-2019 <a style="color: #FFD;" href="//baidu.com">baidu.com </a>All Rights Reserved</div>  
        </div>
        <!-- 底部结束 -->
