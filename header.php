...
<li class="menu-item  menu-item-has-children"><a href="https://www.x6d.com">小刀娱乐网</a></li>
<ul class="sub-menu">
	<li class="menu-item"><a href="./yhq.php">优惠券搜索</a></li>
	<li class="menu-item"><a href="javascript:history.back(-1)" target="_blank">返回上页</a></li>
	<li class="menu-item"><a href="http://www.x6d.com" target="_blank">更多资源</a></li>
	<li class="menu-item"><a target="_blank" href="http://www.x6d.com">资源论坛</a></li>
</ul>
</li>
